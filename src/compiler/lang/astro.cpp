...
void assignment_instruction_c::visit(instruction_receiver_c &ir) { ir.receive(*this); }

void display_expr_tree(const std::string &prefix, expression_c *n, bool is_left)
{
  if (!n) {
    return;
  }
